const en = {
    ...
    about: {
        subheading: "About",
        content: "I am an <AGE>-year-old software developer based in New York, and have been coding since I was 8. Over the years, I have learned a wide range of programming languages and frameworks. While I prioritize backend development, I also have experience in frontend development. My primary focus is on building web applications, and I enjoy contributing to open-source projects, using my skills to create efficient, scalable, and high-performance programs.",
    },
    skills: {
        subheading: "Skills",
        python: "Python",
